...
#
# Tools installed:
#   fteqcc     — QuakeC compiler (needed for ./scripts/compile-qc.sh)
...
printf "\n${BOLD}Project Tatoosh — Tool Setup${RESET}\n\n"
...
printf "\n${BOLD}Done.${RESET} Compile QuakeC with:\n"
printf "  ${BOLD}./scripts/compile-qc.sh${RESET}\n\n"
